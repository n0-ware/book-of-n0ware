...
In this box we are tasked with a basic walkthrough of the various use cases, flags, and outputs of [nmap_usage](../../../tools_and_tricks/tools/nmap_usage.md). 
...
> If you were genuinely concerned about a back door, I would add the `-Pn` flag to this to scan ports even if they do not respond to ping. See the [nmap_usage](../../../tools_and_tricks/tools/nmap_usage.md) note for more scans. 
